...
@auth
<form action="{{ route('supervisor.update', ['supervisor' => $supervisor->id] )}}" method="POST">
    @CSRF
    @method('PUT')
    <div class="container">
        <legend>
            <center>
                <h2><b>Update your information</b></h2>
            </center>
        </legend><br>
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <div class="col-md-8 inputGroupContainer">
                        <div class="input-group">
                            <input type="text" name="name" id="name" value="{{ old('name', $supervisor->name) }}"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 inputGroupContainer">
                        <div class="input-group">
                            <input type="text" name="university" id="university" value="{{ old('university', $supervisor->university) }}"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 inputGroupContainer">
                        <div class="input-group">
                            <input type="text" name="department" id="department" value="{{ old('department', $supervisor->department) }}"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 inputGroupContainer">
                        <div class="input-group">
                            <input type="mail" name="email" id="email" value="{{ old('email', $supervisor->email) }}"
